...
export default function ProfilePage() {
  ...
  return (
    <div className="page">
      ...
      {/* Profile card */}
      <div className="card" style={{ margin: '0 20px 20px', padding: 24, textAlign: 'center' }}>
      ...
      <div style={{ padding: '0 20px' }}>
        {activeTab === 'Collected' && (
          <div>
            {DEMO_COLLECTED.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '40px 20px' }}>
                <div style={{ fontSize: 48, marginBottom: 12 }}>🛍️</div>
                <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>No purchases yet. Find something you love!</p>
                <Link href="/"><button className="btn-primary" style={{ marginTop: 16, width: 'auto', padding: '12px 24px' }}>Browse Items</button></Link>
              </div>
            ) : (
